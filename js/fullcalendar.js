...
var FullCalendar = (function (e) {
  ...
  function Fn(e, t, n, r, i, s, o, a, l, c, d, u, h, f) {
    return {
      ...
      createScrollResponder: (e) =>
        new Ln(e, d, ft(n.scrollTime), n.scrollTimeReset),
  ...
  function pr(e, t, n) {
    ...
    for (let e in o) {
      ...
      if (n.recurringDef) {
        ...
        for (let t of l) {
          let n = gr(e, { start: t, end: r.add(t, o) });
          a[n.instanceId] = n;
        }
      }
    }
  ...
  const vr = {
    ...
    yr = { start: yn, end: yn, date: yn, allDay: Boolean },
  ...
  function Dr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Mr), br),
  ...
  function Cr(e, t = { defs: {}, instances: {} }) {
    return (
  ...
  function jr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Mr), Hr),
      ...
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, s) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (n = pr(n, r, s)), _r(Fr(e, t.sourceId), n);
          }
          return e;
  ...
  class ei {
    ...
    setProp(e, t) {
      if (e in yr)
        ...
        (t = vr[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in vr)
        (t = vr[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Mr) {
        let n = Mr[e](t);
        (n =
          "color" === e
  ...
  class Oi extends A {
    ...
    computeTiming() {
      ...
      return (
        (i = Math.min(864e5, i)),
        { state: { nowDate: r, todayRange: Ni(r) }, waitMs: i }
      );
    }
  ...
  class Pi {
    ...
    addEvent(e, t) {
      if (e instanceof ei) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: Cr({ def: t, instance: n }),
            }),
      ...
      if (i) {
        ...
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Cr(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
  ...
  const Qi = an({ year: "numeric", month: "long", day: "numeric" }),
    qi = an({ week: "long" });
  ...
  class is {
    ...
    similarTo(e) {
      return (
        ss(this.tops || [], e.tops || []) &&
        ss(this.bottoms || [], e.bottoms || []) &&
        ss(this.lefts || [], e.lefts || []) &&
        ss(this.rights || [], e.rights || [])
      );
    }
  }
  function ss(e, t) {
  ...
  class ds {
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (ps(r, t.level, t.levelCoord), ps(n, t.level, [e]))
        : ps(n[t.level], t.lateral, e),
    ...
    findInsertion(e) {
      ...
      let h = -1;
      return (
        u < s && t[u] === o && (h = ms(n[u], e.span.end, us)[0]),
        {
          touchingLevel: a,
          touchingLateral: l,
          touchingEntry: c,
  ...
  const ys = {},
    bs = { startTime: ft, duration: ft, create: Boolean, sourceId: String };
  function Es(e) {
        ...
        (n) =>
          p(
            ...
            p(n, {
              ...
              elAttrs: { "aria-label": t.format(s, Cs) },
            })
          )
      );
    }
  ...
  class Ms {
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(pr(e, Is(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
  ...
  function Go(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return Zo(
          e,
          t.sourceIds ? An(t.sourceIds) : $o(e, r),
          i,
          t.isRefetch || !1,
          r
        );
      ...
      if (a && a !== l) {
        a.timeZone !== l.timeZone &&
          ...
          (t.eventStore = s.eventStore =
            Wr(s.eventStore, n.dateEnv, s.dateEnv)),
          (t.renderableEventStore = s.renderableEventStore =
            Wr(s.renderableEventStore, n.dateEnv, s.dateEnv)));
        for (let e in o)
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(La()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Va {
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!Ga(e.getEventTarget()) && !Hi(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function Ga(e) {
  ...
  class Qa {
    ...
    processFirstCoord(e) {
      let t,
        ...
        r = n,
        i = e.subjectEl;
      i instanceof HTMLElement && ((t = ns(i)), (r = ji(r, t)));
  ...
  class Ja {
    ...
    buildDragMeta(e) {
      return "object" == typeof this.suppliedDragMeta
        ? Es(this.suppliedDragMeta)
        : "function" == typeof this.suppliedDragMeta
        ? Es(this.suppliedDragMeta(e))
        : (function (e) {
            let t = (function (e, t) {
            ...
            return Es(t ? JSON.parse(t) : { create: !1 });
          })(e);
    }
    displayDrag(e, t) {
      ...
      if (this.hiddenConsumes && s) {
        ...
        if (!i[e])
          if (this.allowReslicing) {
            ...
            (i[hs(e)] = !0), (r[o][a] = e), n.push(e), this.splitEntry(s, t, n);
          } else (i[e] = !0), n.push(s);
      }
        ...
        if (e) {
          ...
          if (e.length) {
            ...
            (n.framePositions && n.framePositions.similarTo(r)) ||
              this.setState({ framePositions: new is(t, e, !0, !1) });
          }
        }
  ...
  class Sl extends cs {
    ...
    prepareHits() {
      (this.rowPositions = new is(
        this.rootEl,
        this.rowRefs.collect().map((e) => e.getCellEls()[0]),
        !1,
        !0
      )),
        (this.colPositions = new is(
          this.rootEl,
      ...
      super(...arguments),
        ...
        (this.renderHeadAxis = (e, t = "") => {
          let { options: n } = this.context,
            ...
            i = r.renderRange,
            s =
              1 === xt(i.start, i.end) ? Yi(this.context, i.start, "week") : {};
  ...
  class oc extends cs {
    ...
    render() {
      ...
      return p(Oi, { unit: i ? "minute" : "day" }, (a, l) =>
        p(
          rc,
          Object.assign(
